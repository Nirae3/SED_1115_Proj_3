...
def inverse_kinematics(x, y):
    ...
    theta_S_offset = 0 #math.radians(45)  # adjust Shoulder servo mounding and convert to radians
    theta_E_offset = 0 #math.radians(20)  # adjust elbow servo mounting and convert to raidans
...
def main():
    ...
    move_to(0,0)
    print(f"I went to 0.0 point : {move_to(0,0)} \n I went to 28, 20 point {move_to(28,20)}")
